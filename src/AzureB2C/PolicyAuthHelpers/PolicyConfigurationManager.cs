...
namespace AzureB2C.Policies
{
    ...
    class PolicyConfigurationManager : IConfigurationManager<OpenIdConnectConfiguration>
    {
        ...
        {
            ICollection<SecurityKey> existingSigningTokens = source.SigningKeys;
            ...
            foreach (SecurityKey token in existingSigningTokens)
            {
                other.SigningKeys.Add(token);
            }
